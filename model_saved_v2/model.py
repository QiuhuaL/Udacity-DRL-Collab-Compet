...
class Critic(nn.Module):
    ...
    def __init__(self, input_size, seed, fc1_units=512, fc2_units=256, fc3_units=64):
        """Initialize parameters and build model.
        Params
        ======
        ...
        self.fc2 = nn.Linear(fc1_units, fc2_units)
        self.fc3 = nn.Linear(fc2_units, fc3_units)
        self.fc4_1 = nn.Linear(fc3_units, 1)  # for agent 1
        self.fc4_2 = nn.Linear(fc3_units, 1)  # for agent 2
        self.reset_parameters()
    ...
    def reset_parameters(self):
        ...
        self.fc2.weight.data.uniform_(*hidden_init(self.fc2))
        self.fc3.weight.data.uniform_(*hidden_init(self.fc3))
        self.fc4_1.weight.data.uniform_(-3e-3, 3e-3)
        self.fc4_2.weight.data.uniform_(-3e-3, 3e-3)
    ...
    def forward(self, states_actions):
        ...
        x = F.relu(self.fc2(x))
        x = F.relu(self.fc3(x))
        qv1 = F.relu(self.fc4_1(x))
        qv2 = F.relu(self.fc4_2(x))
